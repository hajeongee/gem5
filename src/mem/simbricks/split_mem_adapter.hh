...
class SplitMEMAdapter
 ...
 private:
  ...
  class IntRespProxyPort : public ResponsePort
  {
   private:
    SplitMEMAdapter *owner;
  ...
  class IntReqProxyPort : public RequestPort
  {
   private:
    SplitMEMAdapter *owner;
  ...
  class PioProxyPort : public ResponsePort
  {
   private:
    SplitMEMAdapter *owner;
 ...
 protected:
  simbricks::base::GenericBaseAdapter<SplitProtoC2M, SplitProtoM2C> adapter;
  bool sync;
 ...
 public:
  PARAMS(SplitMEMAdapter);
  SplitMEMAdapter(const SplitMEMAdapterParams &params);
